...
#         if strategies.get_strategic_preferences_for_voter(situation, voter_index, voting_scheme, happiness_func):
#             strategy_counter += 1
#             break
...
# honest_overall_happiness = situation.total_happiness(honest_winner, happiness_func)
